...
export default function CategoryManagement() {
  ...
  async function handleDelete(node: CategoryTreeNode) {
    ...
    try {
      ...
      // Backend already guards against deleting categories with children/products
      // and returns a clear message — surface it as-is.
      setDeleteError(e instanceof Error ? e.message : "Impossible de supprimer cette catégorie.");
    }
  }

  // Parent options for the form: full tree, minus the node being edited and its own subtree
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-bold text-foreground text-lg">Catégories</h2>
