...
const getBrands = (): Promise<BrandOut[]> => apiGet("/products/brands");

const createBrand = (data: { name: string; logo_url?: string | null }) =>
  apiJson("/products/brands", "POST", data);

const updateBrand = (id: number, data: { name?: string; logo_url?: string | null }) =>
  apiJson(`/products/brands/${id}`, "PATCH", data);

const deleteBrand = (id: number) =>
  apiDelete(`/products/brands/${id}`);
